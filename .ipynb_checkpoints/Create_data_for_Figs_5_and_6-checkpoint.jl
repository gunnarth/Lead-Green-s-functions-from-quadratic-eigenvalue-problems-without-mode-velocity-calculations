...
Energies=collect(0:1.0:10) #Rashba
Energies_ribbon=collect(-5:1.0:5) #Nanoribbon


repIt=10 #how many time to repeat calculation
N=12     #size parameter for matrices, corresponds to size 50
...
for key in keys(SystemType)
    ...
    CSV.write(joinpath(DIR,"Data","TimingData","Data_for_fig_5_and_6.csv"), dfE)
end